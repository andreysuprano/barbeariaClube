...
<div className="badge bg-dark text-wrap" >
  ...
  <li className="list-group-item d-flex justify-content-between align-items-center">
    ...
    <span className="badge bg-dark rounded-pill">R$ 50,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Pézinho
  ...
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Cabelo pai + filho
    <span className="badge bg-dark rounded-pill">R$ 55,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Cabelo + barba
...
<div className="badge bg-dark text-wrap" >
  ...
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Faxina na cara
    <span className="badge bg-dark rounded-pill">R$ 100,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Hidratação facial
    <span className="badge bg-dark rounded-pill">R$ 50,00</span>
  ...
  <li className="list-group-item d-flex justify-content-between align-items-center">
    Quick massage
    <span className="badge bg-dark rounded-pill">R$ 40,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
   Reflexologia
    <span className="badge bg-dark rounded-pill">R$ 60,00</span>
  </li>
</ul>
...
<div className="badge bg-dark text-wrap" >
 Depílação
        ...
        <ul className="list-group">
  <li className="list-group-item d-flex justify-content-between align-items-center">
   Depilação íntima frente
    <span className="badge bg-dark rounded-pill">R$ 50,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
  Depilação íntima trás
    <span className="badge bg-dark rounded-pill">R$ 50,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
  Depilação com máquina
...
<div className="badge bg-dark text-wrap" >
 Pé
        ...
        <ul className="list-group">
  <li className="list-group-item d-flex justify-content-between align-items-center">
  Podologia - calosidades, unhas encravadas e micoses
...
Mão
        ...
        <ul className="list-group">
  <li className="list-group-item d-flex justify-content-between align-items-center">
  Parcial - cortar, lixar e hidratar
    <span className="badge bg-dark rounded-pill">R$ 15,00</span>
  </li>
  <li className="list-group-item d-flex justify-content-between align-items-center">
  Completa - tirando cutículas
    <span className="badge bg-dark rounded-pill">R$ 20,00</span>
  </li>
